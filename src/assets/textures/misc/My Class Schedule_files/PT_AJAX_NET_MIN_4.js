...
if (this.bCallBack || !form || !form.ICAction || !form.ICResubmit || this.id.indexOf('Resubmit') != -1) return true;try {
 ...
 try 
 {
 if ((req.status == 200) || ((req.status == 400) && (this.objGrouplet != null))) 
 {
 try {
...
function PTRTEFillcacheCke5(URI,UrlID,UrlRepository,EditorField,DisplayOnly)
{
 ...
 newdiv.setAttribute('id',divIdName); newdiv.setAttribute('style','none'); newdiv.innerHTML = DOMPurify.sanitize(EditorString, {FORBID_ATTR: ['onerror']}); var images = newdiv.getElementsByTagName('img' ); var imgStr=""; var URLocTemp=URI.split("/"); var URLoc=""; var ImageSource = ""; var imageNew = ""; var img = "";  if (URI.substring(0,4).toLowerCase() != "http") {
