...
<!-- gtag determiner block -->
var uwgtag = "";switch ("CSPRPDB") {
 case "CSTSPDB":
 uwgtag = "G-RTYQGTG8SD"; break; <!-- next env -->
 case "CSQAPDB":
 uwgtag = "G-BFYH19MWS4"; break; <!-- next env -->
 case "CSPRPDB":
 uwgtag = "G-ZCQJVP62ZW"; break; <!-- next env -->
// case other - do nothing
}

<!-- google tag (gtag.js) application block -->
if (uwgtag) {
 loadScript("https://www.googletagmanager.com/gtag/js?id=" + uwgtag, function(){
 window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);}
 gtag('js', new Date()); gtag('config', uwgtag); });}
